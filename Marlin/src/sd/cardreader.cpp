...
void CardReader::startFileprint() {
      ...
      SERIAL_ECHOPAIR("enterStartFilePrint:\"", flag.sdprinting);
  if (isDetected()) {
    flag.sdprinting = true;
    SERIAL_ECHOPAIR("isDetectedStartFilePrint:\"", flag.sdprinting);
    #if SD_RESORT
      flush_presort();
    #endif
  }
...
void CardReader::stopSDPrint(
    ...
    did_pause_print = 0;
  #endif
  SERIAL_ECHOPAIR("enterStopPrint:\"", flag.sdprinting);
