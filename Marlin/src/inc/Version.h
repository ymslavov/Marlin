 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "2.0.x_AN14_1"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2019-01-31"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/InsanityAutomation/Marlin/tree/TM3D_Anet1.4"
