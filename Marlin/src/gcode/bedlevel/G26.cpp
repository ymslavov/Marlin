...
#ifndef G26_XYFEEDRATE
  #define G26_XYFEEDRATE (PLANNER_XY_FEEDRATE() / 3.0)
#endif
...
void move_to(const float &rx, const float &ry, const float &z, const float &e_delta) {
  ...
  feed_value = has_xy_component ? G26_XYFEEDRATE : planner.settings.max_feedrate_mm_s[E_AXIS] / 1.5;
